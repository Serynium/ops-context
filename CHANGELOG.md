...
- Read-only Model Context Protocol endpoint at `/mcp`, implemented as an Effect service over Streamable HTTP. Tools: `list_projects`, `list_events`, `search_events`, `get_event`, and `get_event_group`.
